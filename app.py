...
df = preproccesor.preprocess(df,region_df)
st.sidebar.header('Olympics Analysis')
user_menu =st.sidebar.radio(
    "Select an option",
    ('Medal Tally','Overall Analysis','Country-Wise Analysis','Athletics Analysis')
)
...
if user_menu == 'Medal Tally':
    ...
    elif selected_year != 'Overall' and selected_country != 'Country-Wise Analysis':
...
if user_menu == 'Overall Analysis':
    ...
    st.title('No of Events over the Years(Every Sports)')
...
if user_menu == 'Athletics Analysis':
